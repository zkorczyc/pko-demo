...
The deck must be served from the `pko/` root (not `pko/demo-unified/` alone) — slide 13 embeds the real approval e-mail from `../email-templates/examples/approval-michal.html` via `<iframe>`.

## Two acts

| Act | Persona | Card | Tagline |
|---|---|---|---|
| **01 Pozyskanie** | Michał Kowalski | PKO Visa INFINITE | Zdobądź właściwego klienta |
...
- **Partner collaboration:** RTCDP Collaboration partner is **Allegro** — Michał is a frequent, high-value Allegro shopper, a real PKO ecosystem tie-in. That spend signal (plus occasional international travel, per his bio) is what qualifies him for an ultra-premium card — not a claim that any specific Allegro feature is bundled into it.
- **Card:** **PKO Visa INFINITE** (RRSO 19,31%, credit limit up to 1 000 000 zł, Priority Pass lounges, Fast Track at Chopin Airport, Concierge 24/7, insurance package, Visa Benefit) — chosen over Mastercard Platinum because its premium-travel benefits map much more directly onto "high spend + occasional international travel" than a generic travel-insurance card does.
